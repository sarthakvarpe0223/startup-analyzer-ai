      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-nav">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between max-w-7xl">
          ...
          <Button
            ...
            className="hidden sm:flex rounded-full px-5 h-9 text-sm bg-white/5 hover:bg-white/10 border border-white/10 text-white transition-all hover:border-white/20 active:scale-95"
          >
            Try for free
          </Button>
        </div>
